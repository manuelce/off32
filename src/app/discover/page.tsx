...
const CITIES = ['Milano', 'Roma', 'Torino', 'Bologna', 'Napoli', 'Firenze', 'Pescara', 'Remote']
const LEVELS = ['senior', 'mid', 'junior']

const PROFESSIONALS = [
  { initials: 'PF', name: 'Pietro Ferrante', role: 'Web Developer', city: 'Milano', tags: ['React', 'Next.js', 'Shopify'], bg: '#EEF8F3', color: '#0F6E56', premium: true, projects: 34, rating: 4.9, available: true, level: 'senior', skill: 'web dev', bio: 'Sviluppo eCommerce performanti e app web custom. Non faccio vetrine — faccio strumenti che vendono.' },
